 ...
 * @param bind_protocol The bind protocol.
 * @param dst_ip The destination IP.
 * @param dst_port The destination port.
 * 
 * @return always 0
 */
static __always_inline int LogRuleMsg(u64 now, u32 src_ip, u16 src_port, u32 bind_ip, u16 bind_port, u8 bind_protocol, u32 dst_ip, u16 dst_port)
{
